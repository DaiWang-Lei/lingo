...
import { Matrix3, MeshStandardMaterial, MeshToonMaterial, Vector3 } from "three";
...
const getDefault = (child, property) => {
    var _a, _b;
    var _c;
    return ((_a = (_c = child.userData)[property]) !== null && _a !== void 0 ? _a : (_c[property] = (_b = child.material[property]) !== null && _b !== void 0 ? _b : 0));
};
const setValue = (child, property, factor) => {
    child.material[property] = getDefault(child, property) * factor;
};
const processChild = (child, _toon, _metalnessFactor, _roughnessFactor) => {
...
export default class SimpleObjectManager extends PhysicsItem {
    ...
    intersects(target) {
        ...
        if (this.cannonBody && target.cannonBody) {
            ...
            return (((_a = cannonContactMap.get(this.cannonBody)) === null || _a === void 0 ? void 0 : _a.has(target.cannonBody)) ||
                ((_b = cannonContactMap.get(target.cannonBody)) === null || _b === void 0 ? void 0 : _b.has(this.cannonBody)) || false);
        }
    ...
    get metalnessFactor() {
        var _a;
        return (_a = this._metalnessFactor) !== null && _a !== void 0 ? _a : 1;
    }
