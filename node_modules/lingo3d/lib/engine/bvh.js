...
const shapecast = (function () {
    ...
    function shapecastTraverse(nodeIndex32, geometry, intersectsBoundsFunc, intersectsRangeFunc, nodeScoreFunc = null, nodeIndexByteOffset = 0, // offset for unique node identifier
    depth = 0) {
        ...
        if (isLeaf) {
            ...
            if (c1Intersection === CONTAINED) {
                ...
                c1StopTraversal =
                    c1Intersection &&
                        shapecastTraverse(c1, geometry, intersectsBoundsFunc, intersectsRangeFunc, nodeScoreFunc, nodeIndexByteOffset, depth + 1);
            }
            if (c1StopTraversal)
                return true;
            ...
            if (c2Intersection === CONTAINED) {
                ...
                c2StopTraversal =
                    c2Intersection &&
                        shapecastTraverse(c2, geometry, intersectsBoundsFunc, intersectsRangeFunc, nodeScoreFunc, nodeIndexByteOffset, depth + 1);
            }
            if (c2StopTraversal)
                return true;
            return false;
...
const intersectsGeometry = (function () {
    ...
    return function intersectsGeometry(nodeIndex32, geometry, otherGeometry, geometryToBvh, cachedObb = null) {
        ...
        if (isLeaf) {
            ...
            const leftIntersection = cachedObb.intersectsBox(boundingBox$1) &&
                intersectsGeometry(left, geometry, otherGeometry, geometryToBvh, cachedObb);
            if (leftIntersection)
                return true;
            arrayToBox(BOUNDING_DATA_INDEX(right), float32Array, boundingBox$1);
            const rightIntersection = cachedObb.intersectsBox(boundingBox$1) &&
    ...
    refit(nodeIndices = null) {
        ...
        function _traverse(node32Index, byteOffset, force = false) {
            ...
            if (isLeaf) {
                ...
                if (float32Array[node32Index + 0] !== minx ||
