...
queueMicrotask(() => {
    if (!settings.autoMout || container.parentElement)
        return;
...
createEffect(() => {
    ...
    button.ontouchstart = () => { var _a; return (_a = button.onclick) === null || _a === void 0 ? void 0 : _a.call(button, new MouseEvent("click")); };
    return () => {
